...
public class BidController {
    ...
    @GetMapping("/itemsonly/{itemId}")
    public List<Bid> getBidsByItemIdSorted(@PathVariable long itemId) {
        return bidService.getBidsByItemIdSorted(itemId);
    }
    @GetMapping("/item/{itemId}")
    public List<BidWithUserInfo> getBidsByItemIdWithUserInfo(@PathVariable long itemId) {
        return bidService.getBidsByItemIdWithUserInfo(itemId);
    }
}